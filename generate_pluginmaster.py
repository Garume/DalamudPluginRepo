#Ref: https://github.com/UnknownX7/DalamudPluginRepo/blob/master/generate_pluginmaster.py
import json
import os
import requests
...
def add_extra_fields(manifests):
    for manifest in manifests:
        ...
        manifest['DownloadCount'] = get_release_download_count('Garume', manifest["InternalName"], manifest['AssemblyVersion'])
